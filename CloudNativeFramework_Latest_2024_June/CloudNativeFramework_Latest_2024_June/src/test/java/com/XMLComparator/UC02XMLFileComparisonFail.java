...
public class UC02XMLFileComparisonFail extends BaseTest_TestNG {
	...
	public void compareXMLFiles() throws Exception {
		...
		BufferedReader srcBuffReader = resuableComponents
				.loadXMLFile(globalProp.getProperty("XMLFilePath") + "\\source2.xml");
		BufferedReader tgtBuffReader = resuableComponents
				.loadXMLFile(globalProp.getProperty("XMLFilePath") + "\\target2.xml");
		...
		resuableComponents.compareXMLKeysValues(srcNodeMapList, tgtNodeMapList, test);
		test.log(Status.INFO, "*******************************************");
		resuableComponents.compareXMLKeys(srcNodeMapList, tgtNodeMapList, test);
		test.log(Status.INFO, "*******************************************");
		resuableComponents.compareXMLSequence(srcNodeMapList, tgtNodeMapList, test);
		test.log(Status.INFO, "*******************************************");
