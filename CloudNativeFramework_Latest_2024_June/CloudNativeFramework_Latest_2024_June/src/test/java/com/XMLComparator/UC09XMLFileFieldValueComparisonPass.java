...
public class UC09XMLFileFieldValueComparisonPass extends BaseTest_TestNG {
	...
	public void compareXMLFiles() throws Exception {
		...
		String srcXMLKeys=globalProp.getProperty("SrcXMLKeys");
		String tgtXMLKeys=globalProp.getProperty("TgtXMLKeys");
