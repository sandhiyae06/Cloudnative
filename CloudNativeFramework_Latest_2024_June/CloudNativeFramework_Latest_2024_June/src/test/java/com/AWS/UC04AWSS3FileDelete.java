...
public class UC04AWSS3FileDelete extends BaseTest_TestNG {
	...
	public  void PublishMessgae() throws Exception {
		test = report.createTest("AWS_FileDelete_S3BUcket");
		test.log(Status.INFO, "*********************Delete file in AWS S3 - Starts***********************");
		...
		resuableComponents.deleteFileinS3(bucketName, s3client, globalProp);
