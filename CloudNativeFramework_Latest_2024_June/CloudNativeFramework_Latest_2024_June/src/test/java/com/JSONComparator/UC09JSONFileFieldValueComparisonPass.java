...
public class UC09JSONFileFieldValueComparisonPass extends BaseTest_TestNG {
	...
	public void compareJSONFiles() throws Exception {
		...
		String srcJsonKeys=globalProp.getProperty("SrcJSONKeys");
		String tgtJsonKeys=globalProp.getProperty("TgtJSONKeys");
