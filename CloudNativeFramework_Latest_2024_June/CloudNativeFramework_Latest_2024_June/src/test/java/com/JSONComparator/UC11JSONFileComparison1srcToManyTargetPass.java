...
public class UC11JSONFileComparison1srcToManyTargetPass extends BaseTest_TestNG {
	...
	public void compareJSONFiles() throws Exception {
		...
		JsonElement	srcJsonElement = resuableComponents
				.loadJSONFile(globalProp.getProperty("1SrctoManySourceFolderPath") + "\\source.json");
